...
p <- ggplot(dados, aes(x=Renda))+
  geom_histogram(breaks=c(0.5,1.0,1.5,1.75,2,2.5,3.5),color="black",fill="#1f8179")+
...
Q1 <- quantile(dados$Renda, probs = 0.25,type=2)
Q1
mediana <- median(dados$Renda)
mediana
Q3 <- quantile(dados$Renda, probs = 0.75,type=2)
Q3
